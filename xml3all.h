...
#define _strnicmp strncasecmp
    ...
    inline const wchar_t* XMLU::wc() { return wu.c_str(); }
    inline const char* XMLU::bc() { return tu.c_str(); }
    inline XMLU::operator const wchar_t*() { return wu.c_str(); }
    inline XMLU::operator const char*() { return tu.c_str(); }
    ...
    */
    ...
    inline XML::XML(XML&& x) { operator=(std::forward<XML>(x)); }
